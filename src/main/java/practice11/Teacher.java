   ...
   public LinkedList<Klass> classes;
    ...
    public void update() {
        for (Klass s:classes
            ...
            if (s.getAddStudetName() != null) {
                System.out.print("I am "+this.name+". I know "+s.getAddStudetName()+" has joined Class "+s.getNumber()+".\n");
            }
            if (s.getAddLeaderName() != null) {
                System.out.print("I am "+this.name+". I know "+s.getAddLeaderName()+" become Leader of Class "+s.getNumber()+".\n");
